...
function Destination({ children }: DestinationProps) {
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="px-10 py-6 flex flex-row justify-between items-center shrink-0">
          <div className="flex flex-col gap-1">
            <h2 className="text-2xl font-bold">Manage Destination</h2>
            <p className="text-gray-500 text-sm">
              Atur dan kelola destinasi yang ditawarkan untuk memastikan
        ...
        <div className="p-10 bg-[#F8F8FA] flex-1 overflow-hidden">
          {children}
        </div>
      </div>
    </div>
